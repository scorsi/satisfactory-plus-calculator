...
type SignUpEmailStepProps = {
  sendCode: (emailAddress: string) => Promise<void>;
};

export const SignUpEmailStep = (props: SignUpEmailStepProps) => {
      ...
      >
        {isSubmitting
          ...
          : (!!errors.email
            ...
            : <><PaperAirplaneIcon className="h-4 w-4" /> Send code and continue</>)
        }
      </button>
    </form>
  );
